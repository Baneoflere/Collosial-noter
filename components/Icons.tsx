...
export const MicrophoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12 5.25v-1.5a6 6 0 00-12 0v1.5m12 0a9 9 0 11-18 0a9 9 0 0118 0z" />
  </svg>
);
...
export const HomeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M3 10.5v9A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 19.5v-9M12 21V13.5" />
    </svg>
);
...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 4.186m0-4.186c.105.022.212.043.32.064M7.217 10.907a2.25 2.25 0 012.652-.311m-2.652.311a2.25 2.25 0 00-2.652.311m2.652-.311l3.886-2.276a2.25 2.25 0 012.652.312m-5.548 6.56l3.886 2.276a2.25 2.25 0 002.652-.312m-5.548-6.560a2.25 2.25 0 010-4.186m0 4.186c.105.022.212.043.32.064m-3.536 0a2.25 2.25 0 113.536 0m0 0l3.886 2.276a2.25 2.25 0 002.652-.312" />
    </svg>
);
...
export const LinkedInIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zm-11 5H5v10h3V8zm-1.5-2.25A1.75 1.75 0 0 0 4.75 7.5 1.75 1.75 0 0 0 8.25 5.75 1.75 1.75 0 0 0 6.5 3.5zm11 6.5c0-2.5-1.5-3.5-3-3.5-1.5 0-2.5 1-3 2v-1.5H9v10h3v-5c0-1.5.5-2.5 2-2.5s1.5 1 1.5 2.5V18h3v-6.5z"></path></svg>;
export const SkypeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M21.5 8.19c0-3.3-3.23-6.09-7.19-6.09C9.79 2.1 6.5 4.9 6.5 8.19c0 1.39.69 2.65 1.81 3.66-2.06.69-3.69 2.06-4.25 3.44-.56 1.38-.56 2.88 0 4.25.69 1.75 2.5 3.13 5.44 3.13 2.19 0 4.06-.81 5.06-2.06.94 1.25 2.81 2.06 5.06 2.06 2.94 0 4.75-1.38 5.44-3.13.56-1.37.56-2.87 0-4.25-.56-1.38-2.19-2.75-4.25-3.44 1.12-1.01 1.81-2.27 1.81-3.66zm-10.12 4.06c-2.5 0-4.5-1.81-4.5-4.06s2-4.06 4.5-4.06 4.5 1.81 4.5 4.06-2 4.06-4.5 4.06zm8.31 0c-2.5 0-4.5-1.81-4.5-4.06s2-4.06 4.5-4.06 4.5 1.81 4.5 4.06-2 4.06-4.5 4.06z"></path></svg>;

export const YoutubeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.5v-9l6.5 4.5-6.5 4.5z"></path></svg>;
export const PdfIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M20 2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 11.5c0-.83.67-1.5 1.5-1.5H12v-1H9.5V7H12c.83 0 1.5.67 1.5 1.5v1c0 .83-.67 1.5-1.5 1.5H11v1h2v1.5h-3.5c-.83 0-1.5-.67-1.5-1.5v-1zm5.5 4.5H13v-6h1.5v6zm4-1.5c0 .83-.67 1.5-1.5 1.5h-2.5V9H17c.83 0 1.5.67 1.5 1.5v4zM4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6z"></path></svg>;
export const LinkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"></path></svg>;
